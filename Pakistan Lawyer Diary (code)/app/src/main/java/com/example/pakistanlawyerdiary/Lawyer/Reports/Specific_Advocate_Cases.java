...
public class Specific_Advocate_Cases extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specific__advocate__cases);
        Intent i = getIntent();
        advocate = i.getStringExtra("advocate");
        activity = this;
        t = findViewById(R.id.textview);
        t.setText("Cases With Advocate " + advocate);
        ...
        cursor = db.query(DatabaseContract.CASE.TABLE_NAME,
                ...
                DatabaseContract.CASE.Col_Email + "=?" + " AND " +
                        DatabaseContract.CASE.Col_PartyAdvocateName + "=?"
                , new String[]{email, advocate}, null, null, null, null);
