...
import com.example.pakistanlawyerdiary.Lawyer.Lawyer_Chat;
import com.example.pakistanlawyerdiary.Lawyer.Lawyer_Messages;
...
public class ClientAdapter extends  RecyclerView.Adapter <ClientAdapter.ViewHolder>{
    ...
    public ClientAdapter(Context mcontext, List<  User > musers, boolean isChat)
    {
    ...
    public ClientAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mcontext).inflate(R.layout.lawyerfragment_row_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull ClientAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(mcontext, Lawyer_Messages.class);
                intent.putExtra("userid",user.getUid());
                mcontext.startActivity(intent);
                ((Lawyer_Chat)mcontext).finish();
            }
        });
