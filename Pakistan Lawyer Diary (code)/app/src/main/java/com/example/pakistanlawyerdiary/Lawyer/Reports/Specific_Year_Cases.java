...
public class Specific_Year_Cases extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specific__year__cases);
        Intent i = getIntent();
        year = i.getStringExtra("year");
        activity = this;
        t = findViewById(R.id.textview);
        t.setText("Cases of Year " + year);
        ...
        cursor = db.query(DatabaseContract.CASE.TABLE_NAME,
                ...
                DatabaseContract.CASE.Col_Email + "=?" + " AND " +
                        DatabaseContract.CASE.Col_CaseYear + "=?"
                , new String[]{email, year}, null, null, null, null);
