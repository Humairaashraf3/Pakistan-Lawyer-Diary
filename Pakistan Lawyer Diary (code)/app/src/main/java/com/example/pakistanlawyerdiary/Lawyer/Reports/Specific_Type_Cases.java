...
public class Specific_Type_Cases extends AppCompatActivity {
   ...
   ReportAdapter ccl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specific__type__cases);
        Intent i = getIntent();
        casetype = i.getStringExtra("type");
        activity = this;
        t = findViewById(R.id.textview);
        t.setText("Cases of Type " + casetype);
        ...
        cursor = db.query(DatabaseContract.CASE.TABLE_NAME,
                columns,
                DatabaseContract.CASE.Col_Email + "=?" + " AND " + DatabaseContract.CASE.Col_CaseType + "=?"
                , new String[]{email, casetype}, null, null, null, null);
