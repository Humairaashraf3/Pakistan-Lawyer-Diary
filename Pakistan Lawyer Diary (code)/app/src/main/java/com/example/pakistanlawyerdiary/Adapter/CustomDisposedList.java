...
public class CustomDisposedList  extends BaseAdapter {
    private Activity context;
    ArrayList<CaseData> cd;


    public  CustomDisposedList(Activity context, ArrayList cd) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CustomCaseList.ViewHolder vh;
        if (convertView == null) {
            vh = new CustomCaseList.ViewHolder();
            row = inflater.inflate(R.layout.disposed_cases_row_item, null, true);
            ...
            vh = (CustomCaseList.ViewHolder) convertView.getTag();
        }
